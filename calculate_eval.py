...
MODEL_NAME = "x_model-inter-13751_model-inter-11251_.pt"
...
evaluation_result_summary_csv = f'./outputs/evaluation_dataset_results_new{MODEL_NAME[:-3]}.csv'
...
with open(evaluation_result_summary_csv, 'w', newline='') as file:
    ...
    for dataset in datasets:
        ...
        similarity_score = get_similarity_score_from_file(output_file)
        ...
        [fnmr_fmr0, fnmr_fmr100, fnmr_fmr1000, eer] = evaluate(similarity_score, true_labels[:1001],
                                                               dataset_base_folder,
                                                               values)
